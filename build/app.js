...
class App extends React.Component{
    ...
    render = ()=>{
        return (
            <div>
                 <img id="applepie-image" className="bg" src="./public/images/6296334551_b3d5c27823_b.png"/>
                 <img id="icecream-image" className="bg" src="./public/images/35535918670_f1d12627ff_o.png"/>  
                <img id="crisps-image" className="bg" src="./public/images/6636957665_5e7c4a79de_o.png"/>
                ...
                <div id="impress" data-transition-duration="1000">
                    ...
                    <div id="conclusion" className="step" data-rel-x="1000" data-rel-y="1000">
                        ...
                        <p style={{fontSize: 'small', position: 'absolute', bottom: '30px', left: '300px'}} id="image-credits"
                    ...
                    <div id="overview" className="step" data-x="3000" data-y="2000" data-scale="9" style={{pointerEvents: 'none'}}>
                    </div>
                </div>

            <div id="impress-toolbar"></div>

            <div className="impress-progressbar"><div></div></div>
